...
class App {
    constructor() {
        ...
        this.studentManager = new StudentManager(this.dataManager);
        this.classManager = new ClassManager(this.dataManager);
        this.attendanceManager = new AttendanceManager(this.dataManager);
        this.statisticsManager = new StatisticsManager(this.dataManager);
    ...
    async loadInitialData() {
        try {
            ...
            // 載入學員數據
            await this.studentManager.loadStudents();
            this.renderStudents();
            
            // 載入課堂數據
            await this.classManager.loadClasses();
            this.renderClasses();
